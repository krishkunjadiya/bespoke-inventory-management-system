...
import { ApiError, createProduct } from '../services/api'
    ...
    <div className="space-y-5 max-w-[1000px]">
      <div className="page-header">
        <div>
          ...
          <p className="page-subtitle">Create a new product in your inventory catalog</p>
        </div>
      </div>
      ...
      >
        ...
        <div className="flex items-center gap-2">
          <Link to="/inventory/products" className="btn-secondary btn-sm">Cancel</Link>
          <button
            type="submit"
